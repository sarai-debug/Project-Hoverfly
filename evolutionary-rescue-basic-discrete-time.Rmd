...
## New code 
```{r}
simulate_one_gen_ls <- function(Z_a, Z_A, rN_a, rN_A, hZ_a, hZ_A, pZ_a, pZ_A, mut_rate) {
   ...
   newAdults_a <- rbinom(1, Z_a,  hZ_a)

   newAdults_A <- rbinom(1, Z_A,  hZ_A)

   # adults produce eggs with reproduction rate r

   newEggs_a <- rpois(1, newAdults_a * rN_a)
   ...
   Z_a_new <- rbinom(1,Z_a - newAdults_a + newEggs_a - mut_a_to_A, pZ_a)
 ...
 print(simulate_one_gen_ls(Z_a=1000, Z_A=0, rN_a=2, rN_A=2.5, hZ_a=0.5, hZ_A=0.5, pZ_a=0.1, pZ_A=0.1, mut_rate=0.1))
